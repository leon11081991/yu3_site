      ...
      descriptions: [
        {
          ...
          label: '學習成果',
          content:
            '第一次接觸電商產業的產品優化，並且產品也已發展至一定的成熟度，實作過程中，經常因系統複雜、諸多特殊情境，導致交接設計文件時經常發生反覆溝通確認的情況，為配合敏捷式的開發步調，我學會交付更完整的設計文件，減少工程師需來回查看Flowchart & Mockup 的繁瑣過程，提升團隊協作的效率，讓團隊中不同的角色PO、UX、前後端工程師，皆能快速同步，使整體的專案過程順利進行。'
        }
      ],
      reflectionList: [
        {
